          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-4">
                <div className={`w-10 h-10 flex items-center justify-center ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                  {getRankIcon(agent.rank)}
                </div>
                
                <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${agent.rank <= 3 ? config.gradient : "from-gray-500 to-gray-600"} flex items-center justify-center text-lg font-bold text-white`}>
                  {agent.avatar}
                </div>
