          ...
          <div className="max-w-5xl mx-auto relative z-10">
            ...
            >
              ...
              {/* data-speakable="intro" activates the
                  SpeakableSpecification on detailsWebPageSchema
                  (declared in app/details/layout.tsx). Voice
                  assistants read the H1 + this subtitle as the ~8-
                  second reply to "what is the Omni AI platform?" */}
              <p
