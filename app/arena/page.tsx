...
import { rankConfig, tierNames, valueOverrides, reachOverrides, formatCompact, getChromeStyle } from "@/lib/arena/config";
import type { RankTier } from "@/lib/arena/config";
