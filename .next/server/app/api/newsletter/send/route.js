"use strict";(()=>{var e={};e.id=91,e.ids=[91],e.modules={2934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8812:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>y,patchFetch:()=>h,requestAsyncStorage:()=>m,routeModule:()=>d,serverHooks:()=>g,staticGenerationAsyncStorage:()=>u});var n={};r.r(n),r.d(n,{POST:()=>p});var i=r(9303),o=r(8716),s=r(670),a=r(7070),l=r(9692),c=r(5913);async function p(){try{let e=await (0,l.e)(),t=await (0,c.bk)(e);return a.NextResponse.json({message:"Newsletter sent",subject:t.content.subject,telegram:t.telegramOk,email:t.emailOk,premium_recipients:t.premiumSent})}catch(t){let e=t instanceof Error?t.message:"Unknown error";return console.error("Newsletter send error:",e),a.NextResponse.json({error:e},{status:500})}}let d=new i.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/api/newsletter/send/route",pathname:"/api/newsletter/send",filename:"route",bundlePath:"app/api/newsletter/send/route"},resolvedPagePath:"/Users/janahasson/Desktop/Assets/Interlinked/Clients/Omni AI/Omni AI Website/app/api/newsletter/send/route.ts",nextConfigOutput:"",userland:n}),{requestAsyncStorage:m,staticGenerationAsyncStorage:u,serverHooks:g}=d,y="/api/newsletter/send/route";function h(){return(0,s.patchFetch)({serverHooks:g,staticGenerationAsyncStorage:u})}},5913:(e,t,r)=>{r.d(t,{bk:()=>u});let n=process.env.ANTHROPIC_API_KEY||"",i=process.env.TELEGRAM_BOT_TOKEN||"",o=process.env.TELEGRAM_CHAT_ID||"",s=process.env.RESEND_API_KEY||"",a=process.env.NEWSLETTER_FROM_EMAIL||"newsletter@omni-ai.co",l=process.env.NEWSLETTER_TO_EMAIL||"sitanim8@gmail.com";async function c(){let e=new Date().toLocaleDateString("en-US",{month:"long",day:"numeric",year:"numeric"});if(!n)return p(e);try{let t=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":n,"anthropic-version":"2023-06-01","content-type":"application/json"},body:JSON.stringify({model:"claude-3-5-haiku-20241022",max_tokens:1024,messages:[{role:"user",content:`You are the Omni AI newsletter writer. Generate today's (${e}) daily newsletter.
...
_${e.closing}_`;try{return(await fetch(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:o,text:n,parse_mode:"Markdown"})})).ok}catch(e){return console.error("Telegram send error:",e),!1}}async function m(e,t){if(!s)return!1;let r=new Date().toLocaleDateString("en-US",{month:"long",day:"numeric",year:"numeric"}),n=e.insights.map(e=>`<li style="margin-bottom:12px;line-height:1.6;">${e}</li>`).join(""),i=`<!DOCTYPE html>
