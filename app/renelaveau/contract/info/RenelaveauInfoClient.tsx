...
// Rene Laveau). Rendered verbatim in §6 so the info page carries the
// actual contract, not just the breakdown. Each block is a paragraph
  ...
  return (
    <>
      ...
      <div className="relative z-10 min-h-screen text-zinc-100 renelaveau-info-page">
        ...
        {/* §6 THE AGREEMENT, IN FULL — the actual signed Content
            Engagement & Audience Development Agreement, rendered
            verbatim so the info page carries the real contract. */}
        <Section number="6" title="The agreement, in full">
          <p>
            The full signed Content Engagement &amp; Audience
            Development Agreement, verbatim. Everything above is the
            plain-English breakdown — this is the document itself.
          </p>

          {/* Preamble — parties + effective date */}
          <div className="mt-6 rounded-2xl border border-amber-300/20 bg-amber-300/[0.03] p-5 sm:p-6 text-[14px] text-zinc-300 leading-relaxed">
            ...
            <p className="mt-3">
              <strong className="text-amber-100">
                Sitani Mafi / Omni Leads AGI / Audience Engine / Omni AI
              </strong>{" "}
            ...
            {AGREEMENT.map((clause) => (
              <div key={clause.n} id={`clause-${clause.n}`} className="scroll-mt-16">
                <div className="flex items-baseline gap-3">
                  <span
                    className="text-amber-300/80 tabular-nums text-base shrink-0"
                    style={{ fontFamily: "Georgia, serif" }}
                  >
                    {clause.n}.
                  </span>
                  <h3
                    className="text-base sm:text-lg tracking-tight text-amber-100"
                    style={{ fontFamily: "Georgia, serif" }}
                  >
                    {clause.title}
                  </h3>
                </div>
                <div className="mt-2 ml-6 space-y-2.5 text-[14px] text-zinc-300 leading-relaxed">
            ...
            <div className="mt-5 grid gap-6 sm:grid-cols-2">
              <div>
                ...
                <p className="mt-3 text-[12px] text-zinc-500">
                  Executed by activating the engagement and completing
                  first payment.
                </p>
              </div>
              <div>
