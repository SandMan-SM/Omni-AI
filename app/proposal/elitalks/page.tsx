...
export const metadata: Metadata = {
  ...
  description:
    "Six months. One audience. A paid-social engine running across Meta + YouTube, wired into the full Omni AI federation. Tap through for the full breakdown — every deliverable plus the Omni AI Exclusive Membership tier.",
