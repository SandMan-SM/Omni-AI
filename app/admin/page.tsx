            ...
            <div className="space-y-4">
              <div className="space-y-3 pb-3 border-b border-white/5">
                <Field label="Current Password">
                  <div className="flex-1 bg-white/5 border border-white/10 rounded-md px-3 py-2 text-xs text-gray-500 italic">
                    Hashed \u2014 cannot be displayed. Set a new password below to overwrite it.
                  </div>
                </Field>
