...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  {
    slug: "arizona-phoenix-rentals",
    brand: "Arizona Phoenix Rentals",
    domain: "arizonaphoenixrentals.com",
    url: "https://www.arizonaphoenixrentals.com",
    inboundSlug: "greenwood",
    realm: 1,
    role: "Operator · AI CEO · Furnished rentals",
    status: "live",
    pantheonArchetype: "Operator (mortal tier)",
    pantheonCEO: null,
    tagline: "The Greenwood in Goodyear — a furnished mid-term rental page built to convert travel nurses, relocating professionals, and seasonal residents.",
    problem: "Fred needed the rental to feel like a real destination, not a thin listing page. The offer had to make a brand-new 2024 home, private queen suite, utilities-included pricing, and Avion at Ballpark Village amenities clear before a visitor bounced to Furnished Finder.",
    solution: "Bespoke Next.js rental site with a photo-led hero, room-by-room tour, amenity matrix, neighborhood story, simple pricing, FAQ, and direct Furnished Finder booking CTAs. The page frames The Greenwood as a turnkey West Valley stay while keeping Fred's rental inside the federation partner network.",
    systems: [
      { layer: "Engineering", what: "Next.js + React custom codebase. Single-property funnel optimized for fast mobile scanning and direct booking intent." },
      { layer: "Pages", what: "Home page sections for the private suite, photo tour, amenities, neighborhood, pricing, location, FAQ, and Furnished Finder booking handoff." },
      { layer: "Design", what: "Photo-forward furnished-rental presentation using the real home: bedrooms, bathrooms, kitchen, great room, patio, pool, pickleball, playground, and Goodyear context." },
      { layer: "SEO + JSON-LD", what: "Local rental positioning for Goodyear, Phoenix West Valley, mid-term furnished stays, travel nurse housing, corporate housing, and monthly rentals near Goodyear Ballpark." },
      { layer: "Conversion", what: "Above-the-fold $1,600/mo offer, private queen bedroom + bath proof, all-utilities-included framing, minimum-stay and deposit details, plus persistent Furnished Finder CTAs." },
      { layer: "Federation integration", what: "Greenwood registered in the partner network as a featured West Valley furnished-stay offer for cross-portfolio promotion." },
      { layer: "Ops", what: "Production domain live with SSL, canonical public URL, image alt text, OG-ready content, and booking handoff to Furnished Finder." },
    ],
    agenticStack: [
      ...STANDARD_AGENTIC,
      "Rental-intent routing watches for travel nurse, relocation, corporate housing, seasonal stay, and Goodyear Ballpark demand signals.",
      "Availability and pricing copy is structured so the AI CEO can keep booking prompts aligned with the live Furnished Finder offer.",
      "Partner-network placement lets relevant federation surfaces send high-intent housing traffic into the Greenwood funnel.",
    ],
    pricing: TIER3_PRICING,
    marketTier: "bespoke",
    marketTierLabel: "Tier 3 · Bespoke Next.js",
