...
export const CLIENT_AGENT_REGISTRY: ClientAgentRegistryEntry[] = [
  ...
  },
  {
    ...
    tier: 'tier_1_ai_ceo',
    priority: 8,
    websitePath: 'Live Better Podcast/livebetteronthedrip.com/',
    aiCeoPath: null,
    ...
    nextAction: 'Verify livebetteronthedrip.com inbound forms, GA4 events, Manus social status, and Prime IV Sandy CTA tracking without making medical claims.',
