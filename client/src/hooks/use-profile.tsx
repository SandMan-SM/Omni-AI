    ...
    try {
      ...
      if (error && error.code === 'PGRST116') {
        const newProfile = {
          id: user.id,
          email: user.email || '',
          role: user.email === 'sitanim8@gmail.com' ? 'sponsor' : 'user',
          is_admin: user.email === 'sitanim8@gmail.com' ? true : false,
          is_sponsor: user.email === 'sitanim8@gmail.com' ? true : false,
          tier: user.email === 'sitanim8@gmail.com' ? 3 : 0,
          name: null,
          phone: null,
