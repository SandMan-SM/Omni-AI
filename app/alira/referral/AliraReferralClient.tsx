...
// AliraReferralClient — full-architecture referral surface
...
// the Alira surface and stays as the hero headline. The deal
// terms are Alira's existing ones ($333 deposit → $333/mo over
...
type Props = {
   ...
   * segment (e.g. `/alira/referral/EMPIRE=A12345678` → code
...
export function AliraReferralClient({
  ...
  // shared affiliate URL like /alira/referral/EMPIRE=…
      ...
      <div className="relative z-10 min-h-screen text-zinc-100 alira-referral-page">
        ...
        <section className="relative">
          <div className="mx-auto max-w-5xl px-5 sm:px-6 pt-20 sm:pt-32 pb-10 sm:pb-12">
            ...
            <h1
              className="mt-5 text-4xl sm:text-7xl tracking-tight leading-[1.02]"
            ...
            <div className="mt-5 flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-3 sm:gap-5">
              ...
              {affiliateCode && (
                <p
                  ...
                  data-testid="alira-affiliate-pill"
                >
        ...
        {/* PROOF strip — anchors credibility on alira.live + the
            ...
            <div className="rounded-3xl border-2 border-amber-300/30 bg-gradient-to-br from-amber-300/[0.05] via-amber-300/[0.02] to-transparent p-5 sm:p-10 text-center relative overflow-hidden">
              ...
              <div className="relative z-10 mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                <button
                  ...
                  data-testid="alira-activate-footer"
                >
                  <span className="chrome-white">
                    Activate Your Assets
                  </span>
