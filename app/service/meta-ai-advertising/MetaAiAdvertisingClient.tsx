...
export function MetaAiAdvertisingClient() {
  ...
  // Consultation booking popup (calendar widget) — opened by both the on-page
  // "Schedule Consultation" button and the nav "Book Appointment" button.
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black text-white">
      <Navbar onBookDemo={() => setConsultationOpen(true)} />
      ...
      {/* Consultation popup with the calendar widget — opened by the on-page
          "Schedule Consultation" button and the nav "Book Appointment" button.
          Posts to /api/demo-booking (persists + emails the owner). */}
      <BookDemoModal
        isOpen={consultationOpen}
        onClose={() => setConsultationOpen(false)}
        heading="Book a quick consultation"
        subheading="See what Meta AI can do for your business."
        variant="meta"
      />
    </div>
  );
