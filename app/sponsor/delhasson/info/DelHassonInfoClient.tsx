...
// DelHassonInfoClient — the long-form breakdown of the Del
// Hasson sponsorship agreement. Lifted from the original
// monolithic /sponsor/delhasson client when that page was
// refactored to a 7-second teaser. Carries §1–§8 + the savings
// chart + the embedded Live Better / Alira proof cards + the
// Hasson Enterprises hook in §7.
//
...
// placements (hero / mid between §6 and §7 / footer CTA card)
  ...
  return (
    <>
      ...
      <div className="relative z-10 min-h-screen text-zinc-100 delhasson-sponsor-page">
        ...
        {/* §4 CONTRIBUTION RECOVERY + equity-trade clarification */}
        ...
        {/* MID Activate Sponsorship CTA — between §6 Proof and
            §7 Hasson Enterprises hook, the strongest credibility
        ...
        {/* §7 WHY WE BUILD + Hasson Enterprises hook */}
        ...
        <Section number="8" title="Terms & Next Steps">
          <p>
            ...
            arrangement. To move forward, click Activate Sponsorship,
            select your tier, and sign — Sitani Mafi will then prepare
